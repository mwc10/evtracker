...
{
	if (region.Z.P === region.ae.P)
	{
		return 'on line ' + region.Z.P;
	}
	return 'on lines ' + region.Z.P + ' through ' + region.ae.P;
}
...
var $author$project$Main$StatSet = F6(
	function (hp, att, def, spa, spd, spe) {
		return {A: att, B: def, D: hp, I: spa, J: spd, K: spe};
	});
var $author$project$Main$zero_statset = A6($author$project$Main$StatSet, 0, 0, 0, 0, 0, 0);
var $author$project$Main$init = A7($author$project$Main$Model, $elm$core$Maybe$Nothing, false, $author$project$Main$zero_statset, $author$project$Main$zero_statset, $elm$core$Maybe$Nothing, 0, _List_Nil);
...
var $author$project$Main$clamp_ev = function (val) {
	return A3($elm$core$Basics$clamp, 0, 252, val);
};
var $elm$core$Basics$min = F2(
	function (x, y) {
		return (_Utils_cmp(x, y) < 0) ? x : y;
	});
var $author$project$Main$sum_evs_statset = function (set) {
	return ((((set.D + set.A) + set.B) + set.I) + set.J) + set.K;
};
var $author$project$Main$max_possible_ev = F2(
	function (set, n) {
		return A2(
			$elm$core$Basics$min,
			n,
			A2(
				$elm$core$Basics$max,
				0,
				510 - $author$project$Main$sum_evs_statset(set)));
	});
var $author$project$Main$add_val_to_statset = F2(
	function (_v0, set) {
		var stat = _v0.a;
		var n = _v0.b;
		var clampedN = A2($author$project$Main$max_possible_ev, set, n);
		switch (stat) {
			case 0:
				return _Utils_update(
					set,
					{
						D: $author$project$Main$clamp_ev(clampedN + set.D)
					});
			case 1:
				return _Utils_update(
					set,
					{
						A: $author$project$Main$clamp_ev(clampedN + set.A)
					});
			case 2:
				return _Utils_update(
					set,
					{
						B: $author$project$Main$clamp_ev(clampedN + set.B)
					});
			case 3:
				return _Utils_update(
					set,
					{
						I: $author$project$Main$clamp_ev(clampedN + set.I)
					});
			case 4:
				return _Utils_update(
					set,
					{
						J: $author$project$Main$clamp_ev(clampedN + set.J)
					});
			default:
				return _Utils_update(
					set,
					{
						K: $author$project$Main$clamp_ev(clampedN + set.K)
					});
		}
	});
...
var $author$project$Main$add_koed_evs = F3(
	function (model, pkmn, acc) {
		var pokerusMutl = model.G ? 2 : 1;
		var heldYield = A2(
			$elm$core$Maybe$map,
			function (stat) {
				return _Utils_Tuple2(stat, 8);
			},
			model.U);
		var statList = A2(
			$elm$core$List$map,
			function (_v1) {
				var s = _v1.a;
				var y = _v1.b;
				return _Utils_Tuple2(s, y * pokerusMutl);
			},
			function () {
				if (!heldYield.$) {
					var held = heldYield.a;
					return _List_fromArray(
						[
							held,
		...
		return A3($elm$core$List$foldl, $author$project$Main$add_val_to_statset, acc, statList);
	});
var $author$project$Main$add_pkmn_ko_count = F2(
	function (id, pkmn) {
		return _Utils_eq(pkmn.E, id) ? _Utils_update(
			pkmn,
			{O: 1 + pkmn.O}) : pkmn;
	});
...
var $author$project$Main$add_new_ko = F2(
	function (model, id) {
...
var $author$project$Main$add_new_pkmn = function (model) {
	var uid = model.aa + 1;
	var make_new_list = function (pkmn) {
		return A3(
			$elm$core$List$foldl,
			$elm$core$List$cons,
			_List_Nil,
...
var $author$project$Main$get_stat_value = F2(
	function (set, stat) {
		switch (stat) {
			case 0:
				return set.D;
...
var $author$project$Main$set_setstat_val = F3(
...
var $author$project$Main$SpA = 3;
var $author$project$Main$SpD = 4;
var $author$project$Main$Spe = 5;
var $author$project$Main$item_str_to_stat = function (s) {
	switch (s) {
		case 'None':
			return $elm$core$Maybe$Nothing;
		case 'HP - Power Weight':
			return $elm$core$Maybe$Just(0);
		case 'Attack - Power Bracer':
			return $elm$core$Maybe$Just(1);
		case 'Defense - Power Belt':
			return $elm$core$Maybe$Just(2);
		case 'Special Attack - Power Lens':
			return $elm$core$Maybe$Just(3);
		case 'Special Defense - Power Band':
			return $elm$core$Maybe$Just(4);
		case 'Speed - Power Anklet':
...
var $author$project$Main$remove_pkmn = F2(
	function (list, id) {
		return A2(
			$elm$core$List$filter,
			function (p) {
...
var $author$project$Main$reset_all_kos = function (pkmns) {
	return A2(
		$elm$core$List$map,
		function (p) {
			return _Utils_update(
...
var $author$project$Main$update_newpkmn_name = F2(
	function (name, pkmn) {
		return _Utils_update(
			pkmn,
			{
				F: $elm$core$Maybe$Just(name)
			});
	});
var $author$project$Main$str_to_stat = function (str) {
	switch (str) {
		case 'HP':
			return $elm$core$Maybe$Just(0);
		case 'Att':
...
var $author$project$Main$update_newpkmn_stat = F2(
	function (statstr, pkmn) {
		var stat = A2(
...
var $author$project$Main$update_newpkmn_yield = F2(
	function (yieldstr, pkmn) {
		var _yield = A2(
			$elm$core$Maybe$withDefault,
			1,
			A2(
				$elm$core$Maybe$map,
				$author$project$Main$clamp_pkmn_ev_yield,
				$elm$core$String$toInt(yieldstr)));
		return _Utils_update(
			pkmn,
			{q: _yield});
	});
var $author$project$Main$update_new_pkmn = F2(
	function (msg, pkmn) {
		switch (msg.$) {
			case 0:
				var name = msg.a;
				return A2(
					$elm$core$Maybe$map,
					$author$project$Main$update_newpkmn_name(name),
					pkmn);
			case 1:
				var statstr = msg.a;
				return A2(
					$elm$core$Maybe$map,
					$author$project$Main$update_newpkmn_stat(statstr),
					pkmn);
			default:
				var yieldstr = msg.a;
				return A2(
					$elm$core$Maybe$map,
					$author$project$Main$update_newpkmn_yield(yieldstr),
					pkmn);
		}
	});
var $author$project$Main$update_target_ev = F3(
	function (set, stat, textval) {
		var val = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2(
				$elm$core$Maybe$map,
				$author$project$Main$clamp_ev,
				$elm$core$String$toInt(textval)));
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_update(
					model,
					{
						U: $author$project$Main$item_str_to_stat(item)
					});
			case 1:
				return _Utils_update(
					model,
			...
			case 2:
				...
				return _Utils_update(
					model,
					{
						L: A3($author$project$Main$update_target_ev, model.L, stat, val)
					});
			case 3:
				var stat = msg.a;
				return _Utils_update(
...
var $author$project$Main$all_stat_list = _List_fromArray(
	[0, 1, 2, 3, 4, 5]);
var $author$project$Main$EvBerry = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$SetEvTarget = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
...
var $author$project$Main$ev_status_class = F2(
	function (earned, target) {
		if (!target) {
			...
			var _v0 = A2($elm$core$Basics$compare, earned, target);
			switch (_v0) {
				case 0:
					return 'not-reached';
				case 1:
...
var $author$project$Main$stat_to_str = function (stat) {
	switch (stat) {
		case 0:
			return 'HP';
		case 1:
...
var $author$project$Main$display_stat_evs = F3(
	function (earned, target, stat) {
		var targetVal = A2($author$project$Main$get_stat_value, target, stat);
		var targetValStr = $elm$core$String$fromInt(targetVal);
		var statName = $author$project$Main$stat_to_str(stat);
		var statInputId = statName + 'Input';
		var earnedVal = A2($author$project$Main$get_stat_value, earned, stat);
		var earnedValStr = $elm$core$String$fromInt(earnedVal);
		var labelStr = earnedValStr + ' of ';
		var statusClass = A2($author$project$Main$ev_status_class, earnedVal, targetVal);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id(statName),
					$elm$html$Html$Attributes$class('ev-grid'),
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$class('ev-row-header')
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							$author$project$Main$EvBerry(stat)),
							$elm$html$Html$Attributes$class('neg-button')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('- EV Berry')
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
...
var $author$project$Main$ev_table = F2(
	function (earned, target) {
		var create_stat_cell = A2($author$project$Main$display_stat_evs, earned, target);
		var tableElems = A2($elm$core$List$map, create_stat_cell, $author$project$Main$all_stat_list);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('EvTable')
				]),
			tableElems);
	});
var $author$project$Main$ev_status = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('EVs')
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Reset Earned EVs')
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Reset Target EVs')
					]))
			]));
};
...
var $author$project$Main$str_to_option_elem = function (str) {
	return A2(
...
var $author$project$Main$held_item_list = A2(
	$elm$core$List$map,
...
var $author$project$Main$pokerus_toggle = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('Pokerus')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$id('PokerusCheck')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$label,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$for('PokerusCheck'),
						$elm$html$Html$Attributes$checked(model.G),
						$elm$html$Html$Events$onClick(
						$author$project$Main$TogglePokerus(''))
					]),
				_List_fromArray(
					[
...
var $author$project$Main$ev_selector = F2(
	function (id, cur) {
		var options = A2(
			$elm$core$List$map,
			$author$project$Main$str_to_option_elem,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$value(cur),
					$elm$html$Html$Events$onInput(
					function (s) {
						return $author$project$Main$NewPkmnUpdate(
							$author$project$Main$NewPkmnYield(s));
					})
				]),
			options);
	});
var $elm$html$Html$Attributes$placeholder = $elm$html$Html$Attributes$stringProperty('placeholder');
var $author$project$Main$NewPkmnStat = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$stat_options = A2(
	$elm$core$List$map,
	$author$project$Main$str_to_option_elem,
	A2($elm$core$List$map, $author$project$Main$stat_to_str, $author$project$Main$all_stat_list));
var $author$project$Main$stat_selector = F2(
	function (id, current) {
		return A2(
			$elm$html$Html$select,
			_List_fromArray(
				[
					...
					function (s) {
						return $author$project$Main$NewPkmnUpdate(
							$author$project$Main$NewPkmnStat(s));
					})
				]),
			$author$project$Main$stat_options);
	});
...
var $author$project$Main$add_pkmn_button = function (pkmn) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('AddNewPkmn')
			]),
		_List_fromArray(
			[addModal]));
};
var $author$project$Main$inc_ev_yield = F2(
	function (itemYield, prior) {
		if (!prior.$) {
			var val = prior.a;
			return $elm$core$Maybe$Just(val + itemYield);
		} else {
			return $elm$core$Maybe$Just(itemYield);
		}
	});
var $author$project$Main$stat_comparable = function (stat) {
	switch (stat) {
		case 0:
			return 0;
		case 1:
...
var $author$project$Main$add_ev_item_yield = F2(
	function (held, dict) {
		var held_comp = A2($elm$core$Maybe$map, $author$project$Main$stat_comparable, held);
		if (!held_comp.$) {
			var item = held_comp.a;
			return A3(
				$elm$core$Dict$update,
				item,
				$author$project$Main$inc_ev_yield(8),
				dict);
		} else {
			return dict;
		}
...
var $author$project$Main$calculate_remaining = F2(
	function (evsLeft, _v0) {
		var stat = _v0.a;
		var _yield = _v0.b;
		var statComp = $author$project$Main$stat_comparable(stat);
		var number_remaining = function (evs) {
			return A2(
				$elm$core$Tuple$pair,
				stat,
				$elm$core$Basics$ceiling(1 / (_yield / evs)));
		};
		return A2(
			$elm$core$Maybe$map,
			number_remaining,
			A2($elm$core$Dict$get, statComp, evsLeft));
	});
var $author$project$Main$comparable_to_stat = function (stat_comp) {
	switch (stat_comp) {
		case 0:
			return 0;
		case 1:
...
var $author$project$Main$iter_statset = function (set) {
	return A2(
		$elm$core$List$map,
		function (stat) {
			return _Utils_Tuple2(
				stat,
				A2($author$project$Main$get_stat_value, set, stat));
		},
		$author$project$Main$all_stat_list);
};
var $author$project$Main$diff_target_earned = F2(
	function (target, earned) {
		return $elm$core$Dict$fromList(
			A2(
				...
				function (_v2) {
					...
					var y = _v2.b;
					return _Utils_Tuple2(
						$author$project$Main$stat_comparable(s),
						y);
				},
				A2(
					$elm$core$List$map,
					function (_v1) {
						...
						return _Utils_Tuple2(
							s,
							y - A2($author$project$Main$get_stat_value, earned, s));
					},
					A2(
						$elm$core$List$filter,
						function (_v0) {
						...
						$author$project$Main$iter_statset(target)))));
	});
	...
	function (model, pkmn) {
		...
		var yielded = A2(
			...
			function (_v0) {
				...
				var y = _v0.b;
				return _Utils_Tuple2(
					$author$project$Main$comparable_to_stat(s),
					y * pokerusMult);
			},
			$elm$core$Dict$toList(
				A2(
					$author$project$Main$add_ev_item_yield,
					model.U,
...
var $author$project$Main$fmt_remaining_ev = function (_v0) {
	var stat = _v0.a;
	var left = _v0.b;
	return $elm$core$String$fromInt(left) + (' remaining [' + ($author$project$Main$stat_to_str(stat) + ']'));
};
...
var $author$project$Main$map_pkmn_list = F2(
	function (pkmns, calc_remaining) {
		return A2(
			$elm$core$List$map,
			$author$project$Main$pkmn_to_li(calc_remaining),
			pkmns);
	});
var $elm$html$Html$ul = _VirtualDom_node('ul');
var $author$project$Main$wild_pkmn = function (model) {
	var partial_get_remaning = $author$project$Main$get_remaining(model);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('WildPkmn')
			]),
		_List_fromArray(
			[
				A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Sw/Sh EV Tracker')
					])),
